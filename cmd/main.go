...
func main() {
	...
	flag.IntVar(&webhookBindPort, "webhook-bind-port", 9443, "The port the webhook endpoint binds to.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "027734fd.sgroups.io",
	...
	if err = (&controller.AddressGroupBindingReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "AddressGroupBinding")
		os.Exit(1)
	}
	// nolint:goconst
	...
	if err = (&controller.AddressGroupPortMappingReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "AddressGroupPortMapping")
		os.Exit(1)
	}
	// nolint:goconst
	...
	if err = (&controller.AddressGroupBindingPolicyReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "AddressGroupBindingPolicy")
		os.Exit(1)
	}
	// nolint:goconst
	...
	if err = (&controller.ServiceAliasReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "ServiceAlias")
		os.Exit(1)
	}
	// nolint:goconst
