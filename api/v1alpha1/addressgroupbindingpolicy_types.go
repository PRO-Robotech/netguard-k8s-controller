...
// AddressGroupBindingPolicy is the Schema for the addressgroupbindingpolicies API.
...
func init() {
	SchemeBuilder.Register(&AddressGroupBindingPolicy{}, &AddressGroupBindingPolicyList{})
}
